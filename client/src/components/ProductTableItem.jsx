...
const ProductTableItem = ({ product }) => {
  ...
  const onSaveProduct = () => {
    dispatch(updateProduct(species, name, category, stock, price, product._id, productIsNew, description, image))
  }
      ...
      <Tr>
        ...
        <Td>
          <Flex direction='column' gap='2'>
            <Input size='sm' value={species} onChange={(e) => setSpecies(e.target.value)} />
