...
const ShippingInformation = () => {
  ...
  return (
    <Formik
      initialValues={{ address: '', postalCode: '', city: '', landmark: '' }}
      validationSchema={Yup.object({
        ...
        landmark: Yup.string().required('This field is required.').min(2, 'This landmark is too short.'),
      })}
    >
      {(formik) => (
        <VStack as='form'>
          ...
          >
            ...
            <Flex>
              <Box flex='1' mr='10'>
                <TextField name='postalCode' placeholder='Pin Code' label='Pin Code' type='number' />
              </Box>
              <Box flex='2'>
            ...
            >
              <Stack direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
                <Stack pr='10' spacing={{ base: '8', md: '10' }} flex='1.5'>
                  <Box>
                    <Radio value='true'>
                      <Text fontWeight='bold'>Express ₹30</Text>
                ...
                <Radio value='false'>
                  <Tooltip label='Free shipping for orders of ₹1000 or more!'>
                    <Box>
                      <Text fontWeight='bold'>Standard ₹10</Text>
