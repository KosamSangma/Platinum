...
export const updateProduct =
  (species, name, category, stock, price, id, productIsNew, description, image) => async (dispatch, getState) => {
    const {
      user: { userInfo },
    } = getState()
    ...
    try {
      ...
      const { data } = await axios.put(
        `api/products`,
        { species, name, category, stock, price, id, productIsNew, description, image },
        config
      )
